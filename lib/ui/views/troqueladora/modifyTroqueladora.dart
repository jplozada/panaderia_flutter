...
class ModifyTroqueladora extends StatefulWidget {
  final Troqueladora product;

  ModifyTroqueladora({@required this.product});

  @override
  _ModifyTroqueladoraState createState() => _ModifyTroqueladoraState();
}

class _ModifyTroqueladoraState extends State<ModifyTroqueladora> {
  ...
  List<DropdownMenuItem<String>> getDropDownMenuItemsResponsable() {
    ...
    for (String responsable in _Responsable) {
      items.add(new DropdownMenuItem(
          value: responsable, child: new Text(responsable)));
    }
    return items;
  }
...
//  para el drop box para el Estado
  ...
  void initState() {
    ...
    _currentProducto = widget.product.nombreProducto;

    _dropDownMenuItemsMaquinaria = getDropDownMenuItemsMaquinaria();
    _currentMaquinaria = widget.product.maquinaria;

    _dropDownMenuItemsTurno = getDropDownMenuItemsTurno();
    _currentTurno = widget.product.turno;

    _dropDownMenuItemsResponsable = getDropDownMenuItemsResponsable();
    _currentResponsable = widget.product.responsable;
    super.initState();
  }
